...
function redisConnect() {
  ...
  var self = this;
  var redisArgs = startupArgs.redis;
  if(redisArgs.mode === 'single') {
    client = new Redis(redisArgs.redisNodes.port, redisArgs.redisNodes.host, redisArgs.redisOpts);
    ...
    client = new Redis.Cluster(redisArgs.redisNodes, redisArgs.redisOpts);
  }
