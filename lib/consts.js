...
consts.COMANDS_MAP = {
	...
	"dump": ["\nmake a dump of the V8 heap and cpu for later inspection",
			...
			"example: dump cpu filepath times --force",
			"example: dump memory filepath --force\n"
	],
...
consts.STOP_QUESTION_INFO = "warning : are you really want to stop this server [yes/no] ";
consts.ADD_QUESTION_INFO = "warning : are you really want to add this server [yes/no] ";
