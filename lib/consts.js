...
consts.COMANDS_MAP = {
	...
	"show": ["\nshow infos like : servers, connections",
			...
			"servers, connections, proxy, handler, components, settings",
...
consts.REDIS_PREFIX = "pomelo-regist:";
consts.REDIS_RES_PREFIX = "pomelo-regist-result:";
consts.REDIS_PERIOD = 10*1000;